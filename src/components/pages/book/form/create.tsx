...
import { useBookOptions, useFormBook } from "@/app/(application)/books/server/use.book";
...
export function CreateBook() {
    ...
    const { create, isPending } = useFormBook();
    ...
    const form = useForm<UIBookDTO>({
        resolver: zodResolver(UIBookSchema),
        defaultValues: {
            title: "",
            authors: [],
            categories: [],
    ...
    const onSubmit = async (values: any) => {
        // Lakukan transformasi di sini sebelum kirim ke create()
        ...
        await create({ body: formattedPayload, cover: values.cover });
    };
                ...
                <div className="flex gap-4">
                    ...
                    <div>
                        <CardTitle className="font-bold text-2xl tracking-tight flex items-center gap-2">
                            <BookOpen className="h-6 w-6 hidden md:block" /> Penambahan Buku
                        </CardTitle>
                        <CardDescription className="text-muted-foreground">
                            Input data buku baru ke dalam koleksi perpustakaan.
                        </CardDescription>
                    </div>
                </div>
            </CardHeader>
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                ...
                                <div className="flex items-end gap-2">
                                    <EnhancedCreatableCombobox
                                        ...
                                        className="flex-1"
                                    />
                                    <Link href="/authors/create?ref=/books/create">
                                        <Button
                                            type="button"
                                            size="icon"
                                            variant="outline"
